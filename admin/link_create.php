        ...
        <div class="row">
            <div class='col-md-12 mt-5'>
                ...
                <div class='form-container col-md-4 offset-md-4 mt-5'>
                    <form action="process/links_process.php/add" method="POST">
                    <input type='hidden' name='epi' value="<?php echo  $_GET['epi'] ?>">
                    <input type='hidden' name='on' value="<?php echo $_GET['on']?>">
                    <input type='hidden' name='idprod' value="<?php echo $_GET['idprod']?>">

                        <div class="form-group">
                            <input type="text" name="link" placeholder="Link Name" class="form-control" >
                        </div>
                        <div class='form-group'>
